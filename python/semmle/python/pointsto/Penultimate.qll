...
module PenultimatePointsTo {
    ...
    module API {
        ...
        pragma [noinline]
        predicate class_method_call(Object cls_method, ControlFlowNode attr, FunctionObject func, PenultimateContext context, CallNode call) {
        ...
        private predicate decorator_call(Object method, ClassObject decorator, FunctionObject func) {
            exists(CallNode f, PenultimateContext imp |
...
*/
    ...
    private module SSA {
        ...
        pragma [noinline]
        private predicate cls_parameter_points_to(ParameterDefinition def, PenultimateContext context, Object value, ClassObject cls, ControlFlowNode origin) {
            def.isSelf() and
            exists(CallNode call, PyFunctionObject meth, Object obj, ClassObject objcls, PenultimateContext caller |
        ...
        pragma [noinline]
        private predicate cls_method_object_points_to(CallNode call, PenultimateContext context, PyFunctionObject meth, Object value, ClassObject cls, ControlFlowNode origin) {
