...
module Layer0PointsTo {
    ...
    private predicate class_or_module_attribute(Object obj, string name, Object value, ClassObject cls, ObjectOrCfg orig) {
        ...
        or
        /* Module attributes */
        NonePointsTo::module_attribute_points_to(obj, name, value, cls, orig)
    }
    ...
    private predicate from_import_points_to(ImportMemberNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        exists(string name, ImportExprNode fmod, ModuleObject mod |
            ...
            or
            not NonePointsTo::module_attribute_points_to(mod, name, _, _, _) and
    ...
    module Flow {
        ...
        private predicate ssa_phi_points_to(PhiFunction phi, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            exists(EssaVariable input, BasicBlock pred |
                input = phi.getInput(pred) and not NonePointsTo::prunedEdge(pred, phi.getBasicBlock(), _) and
        ...
        private predicate ssa_node_definition_points_to(EssaNodeDefinition def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            not NonePointsTo::pruned(def.getDefiningNode(), _) and
            (
        ...
        pragma [noinline]
        private predicate callsite_transfer(ControlFlowNode argument, Layer0Context caller, ParameterDefinition param, Layer0Context callee) {
        ...
        private predicate parameter_points_to(ParameterDefinition def, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
            ...
            /* Handle default values -- Layer0 is just for default context.
            ...
            exists(ControlFlowNode param |
                ...
                exists(Layer0Context imp | imp.isImport() | points_to(def.getDefault(), imp, value, cls, origin)) and context.isRuntime()
                or
        ...
        pragma [noinline]
        private predicate module_and_name_for_import_star(ModuleObject mod, string name, ImportStarRefinement def, Layer0Context context) {
        ...
        pragma [noinline]
        private predicate variable_not_redefined_by_import_star(EssaVariable var, Layer0Context context, ImportStarRefinement def) {
    ...
    module Types {
         ...
         ClassObject class_get_meta_class(ClassObject cls) {
             ...
             forall(ClassObject meta |
                 meta = NonePointsTo::Types::class_get_meta_class_candidate(cls) |
         ...
         private Object six_add_metaclass_function() {
             exists(ModuleObject six |
                 six.getName() = "six" and
                 NonePointsTo::module_attribute_points_to(six, "add_metaclass", result, _, _)
             )
         }
