...
module Layer0PointsTo {
    ...
    module API {
        ...
        predicate boolean_const(ControlFlowNode f, Layer0Context context, boolean value) {
    ...
    private predicate points_to_candidate(ControlFlowNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        or
        exists(boolean b |
            NonePointsTo::boolean_const(f, _, b) |
    ...
    private predicate ssa_boolean_const(EssaVariable var, Layer0Context context, boolean value) {
    ...
    private predicate attribute_boolean_const(ModuleObject mod, string name, boolean value, Layer0Context context) {
    ...
    module Types {
         ...
         predicate class_has_attribute(ClassObject cls, string name) {
             extensional_name(name) and
             class_declares_attribute(NonePointsTo::Types::get_an_improper_super_type(cls), name)
         }
