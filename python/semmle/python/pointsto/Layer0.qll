...
module Layer0PointsTo {
    ...
    module API {
        ...
        CallNode get_a_call(FunctionObject func, Layer0Context context) {
        ...
        predicate function_call(FunctionObject func, Layer0Context context, CallNode call) {
        ...
        predicate method_call(FunctionObject func, Layer0Context context, CallNode call) {
        ...
        pragma [noinline]
        predicate class_method_call(Object cls_method, ControlFlowNode attr, FunctionObject func, Layer0Context context, CallNode call) {
        ...
        private predicate decorator_call(Object method, ClassObject decorator, FunctionObject func) {
            exists(CallNode f, Layer0Context imp |
        ...
        predicate points_to(ControlFlowNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        predicate py_module_attributes(Module m, string name, Object obj, ClassObject cls, ControlFlowNode origin) {
            exists(EssaVariable var, ControlFlowNode exit, ObjectOrCfg orig, Layer0Context imp |
            ...
            if version111plus() then (
                exists(EssaVariable var, Layer0Context imp |
                 ...
                 * Layer0 can be removed 2018, once the dbscheme has been upgraded from e7f9ea.
                 */
        ...
        predicate version_const(CompareNode cmp, Layer0Context context, boolean value) {
        ...
        ControlFlowNode get_positional_argument_for_call(FunctionObject func, Layer0Context context, CallNode call, int position) {
        ...
        ControlFlowNode get_named_argument_for_call(FunctionObject func, Layer0Context context, CallNode call, string name) {
          (
        ...
        predicate super_call(CallNode call, Layer0Context context, EssaVariable self, ClassObject start) {
        ...
        predicate instantiation(CallNode f, Layer0Context context, ClassObject cls) {
        ...
        predicate ssa_variable_points_to(EssaVariable var, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        predicate super_bound_method(AttrNode f, Layer0Context context, EssaVariable self, Object function) {
    ...
    module Layer {
        ...
        predicate reachable(ControlFlowNode f, Layer0Context context) {
         ...
         */
        predicate controlledReachableEdge(BasicBlock pred, BasicBlock succ, Layer0Context context) {
     ...
     */
    private predicate os_const(ControlFlowNode f, Layer0Context context, boolean value) {
        exists(string os |
    ...
    pragma [nomagic]
    private predicate points_to_candidate(ControlFlowNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        or
    f.(Layer0CustomPointsToFact).pointsTo(context, value, cls, origin)
    }
    ...
    private predicate use_points_to_maybe_origin(NameNode f, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin_or_obj) {
    ...
    private predicate name_lookup_points_to_maybe_origin(NameNode f, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin_or_obj) {
    ...
    private predicate global_lookup_points_to_maybe_origin(NameNode f, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin_or_obj) {
    ...
    private predicate use_points_to(NameNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
    ...
    private predicate def_points_to(DefinitionNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        points_to(f.getValue(), context, value, cls, origin)
    }

    /** Holds if `f` points to `@six.add_metaclass(cls)\nclass ...`. */
    private predicate six_metaclass_points_to(ControlFlowNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        exists(ControlFlowNode meta |
    ...
    pragma [noinline]
    private predicate instance_attribute_load_points_to(AttrNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        f.isLoad() and
        exists(string name |
    ...
    pragma [noopt]
    private predicate class_or_module_attribute_node(AttrNode f, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg orig) {
    ...
    private predicate attribute_load_points_to(AttrNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
    ...
    private predicate if_exp_points_to(IfExprNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
    ...
    pragma [nomagic]
    private predicate from_import_points_to(ImportMemberNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
    ...
    private predicate getattr_points_to(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
     ...
     */
    private predicate binary_expr_points_to(BinaryExprNode b, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        cls = theIntType() and
    ...
    pragma [noinline]
    private predicate incomparable_values(CompareNode cmp, Layer0Context context) {
        exists(ControlFlowNode left, ControlFlowNode right |
    ...
    pragma [noinline]
    private Object in_tuple(CompareNode cmp, Layer0Context context) {
        exists(ControlFlowNode left, ControlFlowNode right |
    ...
    pragma [noinline]
    private predicate const_compare(CompareNode cmp, Layer0Context context, int comp, boolean strict) {
        exists(ControlFlowNode left, ControlFlowNode right |
    ...
    pragma [noinline]
    private Object version_tuple_compare(CompareNode cmp, Layer0Context context) {
...
/*
    pragma [noinline]
    private Object version_hex_compare(CompareNode cmp, Layer0Context context) {
        exists(ControlFlowNode lesser, ControlFlowNode greater, boolean strict |
            inequality(cmp, lesser, greater, strict) and
            exists(TupleObject tuple, int comp |
                points_to(lesser, context, tuple, _, _) and
...
*/
    private predicate compare_expr_points_to(CompareNode cmp, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
    ...
    private predicate not_points_to(UnaryExprNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
    ...
    private predicate equality_expr_points_to(CompareNode cmp, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        cls = theBoolType() and origin = cmp and
    ...
    private predicate subscript_points_to(SubscriptNode sub, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
    ...
    private predicate sys_version_info_index(SubscriptNode s, Layer0Context context, NumericObject value, ClassObject cls) {
    ...
    private predicate sys_version_info_slice(SubscriptNode s, Layer0Context context, ClassObject cls) {
    ...
    private predicate sys_version_string_char0(SubscriptNode s, Layer0Context context, Object value, ClassObject cls) {
    ...
    private predicate os_test(ControlFlowNode f, string os, Layer0Context context) {
    ...
    predicate named_attribute_points_to(ControlFlowNode f, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
        exists(EssaVariable var |
            var.getAUse() = f |
    ...
    private module Calls {
         ...
         private predicate call_to_type(CallNode f, ControlFlowNode arg, Layer0Context context) {
         ...
         pragma [noinline]
         predicate call_to_type_known_python_class_points_to(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
         ...
         pragma [noinline]
         predicate call_to_type_known_builtin_class_points_to(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
             exists(ControlFlowNode arg |
         ...
         pragma [noinline]
         predicate call_points_to_builtin_function(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
         ...
         predicate type_test_call(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
            cls = theBoolType() and origin = f and
            (
          ...
          */
        private predicate annotation_call(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
         ...
         private predicate call_to_isinstance(CallNode f, Layer0Context context, Object value) {
         ...
         private predicate call_to_issubclass(CallNode f, Layer0Context context, Object value) {
         ...
         pragma [noinline]
         predicate call_to_procedure_points_to(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
         ...
         predicate call_to_unknown(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
         ...
         predicate call_to_generator_points_to(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
             exists(PyFunctionObject func |
         ...
         predicate return_val_points_to(PyFunctionObject func, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
         ...
         pragma [noinline]
         predicate call_points_to_python_function(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
             exists(PyFunctionObject func, Layer0Context callee |
          ...
          */
         predicate call_points_to(CallNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
             /* Case 1 */
          ...
          */
         predicate super_method_call(Layer0Context context, CallNode call, EssaVariable self, FunctionObject method) {
         ...
         /** INTERNAL -- Use `FunctionObject.getAMethodCall()`. */
         pragma [nomagic]
         predicate plain_method_call(FunctionObject func, Layer0Context context, CallNode call) {
          ...
          */
         predicate receiver_type_for(ClassObject cls, string name, ControlFlowNode n, Layer0Context context) {
          ...
          */
         pragma [nomagic]
         ControlFlowNode get_argument_for_call_by_position(FunctionObject func, Layer0Context context, CallNode call, int position) {
         ...
         ControlFlowNode get_argument_for_call_by_name(FunctionObject func, Layer0Context context, CallNode call, string name) {
    ...
    module Flow {
        ...
        predicate scope_entry_value_transfer(EssaVariable pred_var, Layer0Context pred_context, ScopeEntryDefinition succ_def, Layer0Context succ_context) {
        ...
        pragma [noinline]
        private predicate scope_entry_value_transfer_from_earlier(EssaVariable pred_var, Layer0Context pred_context, ScopeEntryDefinition succ_def, Layer0Context succ_context) {
        ...
        pragma [noinline]
        private predicate callsite_entry_value_transfer(EssaVariable caller_var, Layer0Context caller_context, ScopeEntryDefinition entry_def, Layer0Context callee_context) {
        ...
        predicate callsite_exit_value_transfer(EssaVariable callee_var, Layer0Context callee_context, CallsiteRefinement def, Layer0Context callsite_context) {
        ...
        predicate callsite_argument_transfer(ControlFlowNode argument, Layer0Context caller, ParameterDefinition param, Layer0Context callee) {
        ...
        predicate callsite_calls_function(CallNode call, Layer0Context caller, PyFunctionObject func, Layer0Context callee, int parameter_offset) {
            /* Functions */
        ...
        predicate module_and_name_for_import_star(ModuleObject mod, string name, ImportStarRefinement def, Layer0Context context) {
        ...
        predicate variable_not_redefined_by_import_star(EssaVariable var, Layer0Context context, ImportStarRefinement def) {
    ...
    private module SSA {
        ...
        pragma [noinline]
        private predicate ssa_phi_points_to(PhiFunction phi, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        predicate ssa_definition_points_to(EssaDefinition def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        pragma [nomagic]
        private predicate ssa_node_definition_points_to_unpruned(EssaNodeDefinition def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        pragma [noinline]
        private predicate ssa_node_definition_points_to(EssaNodeDefinition def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            reachable_definitions(def) and
            ssa_node_definition_points_to_unpruned(def, context, value, cls, origin)
        }

        pragma [noinline]
        private predicate ssa_node_refinement_points_to(EssaNodeRefinement def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        pragma [noinline]
        private predicate assignment_points_to(AssignmentDefinition def, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
            points_to(def.getValue(), context, value, cls, origin)
        }

        /** Helper for `parameter_points_to` */
        pragma [noinline]
        private predicate positional_parameter_points_to(ParameterDefinition def, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
            exists(Layer0Context caller, ControlFlowNode arg |
        ...
        pragma [noinline]
        private predicate parameter_points_to(ParameterDefinition def, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        private predicate default_or_special_parameter_points_to(ParameterDefinition def, Object value, ClassObject cls, ControlFlowNode origin) {
            exists(ControlFlowNode param |
                ...
                exists(Layer0Context imp | imp.isImport() | points_to(def.getDefault(), imp, value, cls, origin))
                or
        ...
        pragma [noinline]
        private predicate callsite_self_argument_transfer(EssaVariable obj, Layer0Context caller, ParameterDefinition self, Layer0Context callee) {
            self.isSelf() and
        ...
        pragma [noinline]
        private predicate self_parameter_points_to(ParameterDefinition def, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
            def.isSelf() and
            ...
            or
            exists(EssaVariable obj, Layer0Context caller |
        ...
        pragma [noinline]
        private predicate cls_parameter_points_to(ParameterDefinition def, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
            def.isSelf() and
            exists(CallNode call, PyFunctionObject meth, Object obj, ClassObject objcls, Layer0Context caller |
        ...
        pragma [noinline]
        private predicate cls_method_object_points_to(CallNode call, Layer0Context context, PyFunctionObject meth, Object value, ClassObject cls, ControlFlowNode origin) {
         ...
         *
         * Layer0 isn't exactly how the interpreter works, but is the best approximation we can manage statically.
         */
        pragma [noinline]
        private predicate implicit_submodule_points_to(ImplicitSubModuleDefinition def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        pragma [noinline]
        private predicate module_name_points_to(ImplicitModuleNameDefinition def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            cls = theStrType() and
        ...
        pragma [noinline]
        private predicate scope_entry_points_to(ScopeEntryDefinition def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            /* Transfer from another scope */
            exists(EssaVariable var, Layer0Context outer |
         ...
         */
        pragma [noinline]
        private predicate callsite_points_to(CallsiteRefinement def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            exists(EssaVariable var, Layer0Context callee |
        ...
        private predicate method_callsite_points_to(MethodCallsiteRefinement def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        private predicate import_star_points_to(ImportStarRefinement def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        pragma [noinline]
        private predicate attribute_assignment_points_to(AttributeAssignment def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        /** Ignore the effects of calls on their arguments. Layer0 is an approximation, but attempting to improve accuracy would be very expensive for very little gain. */
        pragma [noinline]
        private predicate argument_points_to(ArgumentRefinement def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            ssa_variable_points_to(def.getInput(), context, value, cls, origin)
        }

        /** Attribute deletions have no effect as far as value tracking is concerned. */
        pragma [noinline]
        private predicate attribute_delete_points_to(EssaAttributeDeletion def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            ssa_variable_points_to(def.getInput(), context, value, cls, origin)
        }

        /* Data flow for attributes. These mirror the "normal" points-to predicates.
         * For each points-to predicate `xxx_points_to(XXX def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin)`
         * There is an equivalent predicate that tracks the values in attributes:
         * `xxx_named_attribute_points_to(XXX def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin)`
         *  */
         ...
         */
        predicate ssa_variable_named_attribute_points_to(EssaVariable var, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        private predicate ssa_definition_named_attribute_points_to(EssaDefinition def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        pragma[noinline]
        private predicate ssa_node_definition_named_attribute_points_to(EssaNodeDefinition def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        /** Helper for `ssa_definition_named_attribute_points_to`. */
        pragma[noinline]
        private predicate ssa_node_refinement_named_attribute_points_to(EssaNodeRefinement def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        pragma[noinline]
        private predicate scope_entry_named_attribute_points_to(ScopeEntryDefinition def, Layer0Context context, string name, Object value, ClassObject cls, ObjectOrCfg origin) {
            exists(EssaVariable var, Layer0Context outer |
                Flow::scope_entry_value_transfer(var, outer, def, context) and
        ...
        pragma[noinline]
        private predicate assignment_named_attribute_points_to(AssignmentDefinition def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
            named_attribute_points_to(def.getValue(), context, name, value, cls, origin)
        }

        pragma[noinline]
        private predicate attribute_assignment_named_attribute_points_to(AttributeAssignment def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        pragma[noinline]
        private predicate argument_named_attribute_points_to(ArgumentRefinement def, Layer0Context context, string name, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        pragma[noinline]
        private predicate callee_self_variable(EssaVariable var, Layer0Context callee, SelfCallsiteRefinement def, Layer0Context caller) {
        ...
        pragma[noinline]
        private predicate self_callsite_named_attribute_points_to(SelfCallsiteRefinement def, Layer0Context context, string name, Object value, ClassObject cls, ObjectOrCfg origin) {
            exists(EssaVariable var, Layer0Context callee |
        ...
        pragma [noinline]
        private predicate self_parameter_named_attribute_points_to(ParameterDefinition def, Layer0Context context, string name, Object value, ClassObject vcls, ControlFlowNode origin) {
            ...
            or
            exists(FunctionObject meth, CallNode call, Layer0Context caller_context, ControlFlowNode obj |
        ...
        private predicate delete_named_attribute_points_to(DeletionDefinition def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
            none()
        }

        private predicate attribute_delete_named_attribute_points_to(EssaAttributeDeletion def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
            none()
        }

        /* Helper for import_star_named_attribute_points_to */
        pragma [noinline]
        private predicate star_variable_import_star_module(ImportStarRefinement def, ImportStarNode imp, Layer0Context context, ModuleObject mod) {
        ...
        pragma [noinline]
        private predicate import_star_named_attribute_points_to(ImportStarRefinement def, Layer0Context context, string name, Object value, ClassObject cls, ControlFlowNode origin) {
    ...
    private module Filters {
         ...
         * Layer0 is true for basic objects like 3 or None, but it is also true for sentinel objects.
         */
         ...
         * Layer0 is true for basic objects like 3 or None.
         */
        ...
        predicate ssa_filter_definition_points_to(PyEdgeRefinement def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
        ...
        pragma [noinline]
        predicate uni_edged_phi_points_to(SingleSuccessorGuard uniphi, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            exists(ControlFlowNode test, ControlFlowNode use |
    ...
    module Types {
         ...
         * then `(C, name, 1, B1)` and `(C, name, 0, B0)` both hold. Layer0 is a conservative approximation.
         */
        pragma [noopt]
         ...
         * Layer0 is a conservative approximation.
         */
        pragma [noinline] 
