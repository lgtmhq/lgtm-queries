...
module Layer0PointsTo {
    ...
    module API {
        ...
        predicate points_to(ControlFlowNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
            ...
            not NonePointsTo::Layer::pruned(f, _)
        }
    ...
    module Layer {
        ...
        predicate pruned(ControlFlowNode f, Layer0Context context) {
         ...
         */
        predicate prunedEdge(BasicBlock pred, BasicBlock succ, Layer0Context context) {
            exists(ConditionBlock guard |
    ...
    pragma [noinline]
    private predicate class_or_module_attribute_node(AttrNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        f.isLoad() and
    ...
    private predicate from_import_points_to(ImportMemberNode f, Layer0Context context, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        exists(string name, ImportExprNode fmod, ModuleObject mod |
            ...
            or
            not NonePointsTo::Layer::module_attribute_points_to(mod, name, _, _, _) and
    ...
    private predicate sys_version_info_index(SubscriptNode s, Layer0Context context, ClassObject cls) {
    ...
    private predicate sys_version_string_char0(SubscriptNode s, Layer0Context context, ClassObject cls) {
    ...
    pragma [noinline]
    private predicate version_info_object(ControlFlowNode f, Layer0Context context, int v, string kind) {
        exists(Object vobj |
    ...
    private predicate const_object(ControlFlowNode f, int n, string kind) {
        exists(Object const |
            NonePointsTo::points_to(f, _, const, _, _) |
    ...
    private module Booleans {
        ...
        predicate const(ControlFlowNode f, Layer0Context context, boolean value) {
        ...
        predicate ssa_const(EssaVariable var, Layer0Context context, boolean value) {
        ...
        predicate attribute_const(ModuleObject mod, string name, boolean value, Layer0Context context) {
    ...
    module Flow {
        ...
        pragma [noinline]
        private predicate scope_entry_value_transfer_at_callsite(EssaVariable pred_var, Layer0Context pred_context, ScopeEntryDefinition succ_def, Layer0Context succ_context) {
            exists(CallNode callsite, FunctionObject f |
                NonePointsTo::get_a_call(f, _) = callsite and
        ...
        predicate callsite_transfer(ControlFlowNode argument, Layer0Context caller, ParameterDefinition param, Layer0Context callee) {
    ...
    private module SSA {
        ...
        private predicate ssa_phi_points_to(PhiFunction phi, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            exists(EssaVariable input, BasicBlock pred |
                input = phi.getInput(pred) and not NonePointsTo::Layer::prunedEdge(pred, phi.getBasicBlock(), _) and
        ...
        private predicate ssa_node_definition_points_to(EssaNodeDefinition def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            not NonePointsTo::Layer::pruned(def.getDefiningNode(), _) and
            (
        ...
        predicate self_type(FunctionObject method, ClassObject cls) {
            ...
            and
            not NonePointsTo::Types::abstract_class(cls)
        }

        /** Holds if the `(obj, caller)` pair matches up with `(self, callee)` pair across call. */
        pragma [noinline]
        private predicate self_callsite_transfer(EssaVariable obj, Layer0Context caller, ParameterDefinition self, Layer0Context callee) {
            self.isSelf() and
        ...
        private predicate callsite_points_to(CallsiteRefinement def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            ...
            or
            not NonePointsTo::get_a_call(_, _) = def.getDefiningNode() and
        ...
        private predicate attribute_assignment_points_to(AttributeAssignment def, Layer0Context context, Object value, ClassObject cls, ObjectOrCfg origin) {
            if def.getName() = "__class__" then
                Layer::ssa_variable_points_to(def.getInput(), context, value, _, _) and NonePointsTo::points_to(def.getValue(), _, cls, _,_) and
    ...
    module Types {
         ...
         predicate class_declared_attribute(ClassObject owner, string name, Object value, ClassObject vcls, ObjectOrCfg origin) {
             /* Note that src_var must be a local variable, we aren't interested in the value that any global variable may hold */
              ...
              exists(EssaVariable var, LocalVariable src_var |
                 ...
                 NonePointsTo::Layer::ssa_variable_points_to(var, _, value, vcls, origin)
             )
             or
         ...
         private Object six_add_metaclass_function() {
             exists(ModuleObject six |
                 six.getName() = "six" and
                 NonePointsTo::Layer::module_attribute_points_to(six, "add_metaclass", result, _, _)
             )
         }
