...
module FinalPointsTo {
    ...
    module API {
         ...
         * and `expr` is a test (a branch) and contains `use`. */
         cached 
        boolean test_evaluates_boolean(ControlFlowNode expr, ControlFlowNode use, FinalContext context, Object val, ClassObject cls, ControlFlowNode origin) {
...
*/
    ...
    module Flow {
        ...
        pragma [noinline]
        private predicate callsite_entry_value_transfer(EssaVariable caller_var, FinalContext caller_context, ScopeEntryDefinition entry_def, FinalContext callee_context) {
    ...
    private module SSA {
        ...
        pragma [noinline]
        private predicate delete_points_to(DeletionDefinition def, FinalContext context, Object value, ClassObject cls, ControlFlowNode origin) {
        ...
        private predicate callsite_points_to(CallsiteRefinement def, FinalContext context, Object value, ClassObject cls, ObjectOrCfg origin) {
            ...
            (
                ...
                not PenultimatePointsTo::get_a_call(_, _) = def.getDefiningNode() or
                // An identifiable callee is a builtin
                exists(BuiltinCallable opaque | PenultimatePointsTo::get_a_call(opaque, _) = def.getDefiningNode()) or
                ...
                exists(PyFunctionObject modifier |
                    PenultimatePointsTo::get_a_call(modifier, _) = def.getDefiningNode() and
    ...
    private module Filters {
        ...
        pragma [nomagic]
        boolean evaluates_boolean(ControlFlowNode expr, ControlFlowNode use, FinalContext context, Object val, ClassObject cls, ControlFlowNode origin) {
    ...
    module Types {
         ...
         * then `(C, name, 1, B1)` and `(C, name, 0, B0)` both hold. Final is a conservative approximation.
         */
        pragma [noopt]
         ...
         * Final is a conservative approximation.
         */
        pragma [noinline] 
