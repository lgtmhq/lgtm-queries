...
class MethodProcessBuilderCommand extends Method {
  MethodProcessBuilderCommand() {
    hasName("command")
    and getDeclaringType() instanceof TypeProcessBuilder
  }
}
...
class MethodRuntimeExec extends Method {
  MethodRuntimeExec() {
    hasName("exec")
    and getDeclaringType() instanceof TypeRuntime
  }
}
...
class WriteObjectMethod extends Method {
  WriteObjectMethod() {
    hasName("writeObject")
    and (getDeclaringType() instanceof TypeObjectOutputStream or
...
class ReadObjectMethod extends Method {
  ReadObjectMethod() {
    this.getDeclaringType().hasQualifiedName("java.io", "ObjectInputStream")
    and (this.hasName("readObject") or
...
class ClassNameMethod extends Method {
  ClassNameMethod() {
    hasName("getName")
    and getDeclaringType() instanceof TypeClass
  }
}
